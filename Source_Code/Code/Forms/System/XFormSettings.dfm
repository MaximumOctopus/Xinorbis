object FormSettings: TFormSettings
  ...
  object pGeneral: TPanel
    ...
    object tsAutoCheckUpdates: TToggleSwitch
      Left = 25
      Top = 35
      Width = 73
      Height = 20
    ...
    object tsFolderHistory: TToggleSwitch
      Left = 25
      Top = 69
      Width = 73
      Height = 20
      TabOrder = 5
      OnClick = tsFolderHistoryClick
    end
    object tsLogEnable: TToggleSwitch
      Left = 130
      Top = 106
      Width = 73
      Height = 20
    ...
    object tsAllowSQLInSearch: TToggleSwitch
      Left = 130
      Top = 137
      Width = 73
      Height = 20
    ...
    object tsLogging: TToggleSwitch
      Left = 26
      Top = 401
      Width = 73
      Height = 20
  ...
  object pPostScan: TPanel
    ...
    object rbPSDoNothing: TRadioButton
      Left = 17
      Top = 42
      Width = 113
      Height = 17
    ...
    object rbPSSummary: TRadioButton
      Left = 17
      Top = 65
      Width = 113
      Height = 17
    ...
    object rbPSInformationPage: TRadioButton
      Left = 17
      Top = 89
      Width = 113
      Height = 17
    ...
    object rbPSFolderStructure: TRadioButton
      Left = 17
      Top = 157
      Width = 113
      Height = 17
  ...
  object pNavigate: TPanel
    ...
    object sgNavigationSide: TStringGrid
      Left = 96
      Top = 208
      Width = 537
      Height = 228
  ...
  object pOptimisations: TPanel
    ...
    object tsODateTree: TToggleSwitch
      Left = 34
      Top = 69
      Width = 73
      Height = 20
    ...
    object tsOFileNamesDateTree: TToggleSwitch
      Left = 34
      Top = 103
      Width = 73
      Height = 20
      TabOrder = 4
      OnClick = tsOFileNamesDateTreeClick
    end
    object tsOFileNameDateTreeLimit: TToggleSwitch
      Left = 136
      Top = 138
      Width = 73
      Height = 20
    ...
    object tsOIgnoreOwner: TToggleSwitch
      Left = 34
      Top = 167
      Width = 73
      Height = 20
    ...
    object tsOIgnoreTemporary: TToggleSwitch
      Left = 34
      Top = 205
      Width = 73
      Height = 20
