...
void __fastcall TFormSettings::tsFolderHistoryClick(TObject *Sender)
{
	tsLogEnable->Enabled = SliderStateToBoolean(tsFolderHistory->State);

	tsAllowSQLInSearch->Enabled = SliderStateToBoolean(tsFolderHistory->State);
}

void __fastcall TFormSettings::tsOFileNamesDateTreeClick(TObject *Sender)
{
	tsOFileNameDateTreeLimit->Enabled = SliderStateToBoolean(tsOFileNamesDateTree->State);

	eShowFilesInTypeBoxLimit->Enabled  = SliderStateToBoolean(tsOFileNamesDateTree->State);
}
