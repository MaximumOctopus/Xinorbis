...
#pragma resource "*.dfm"
TFormCategoryColours *FormCategoryColours;
//---------------------------------------------------------------------------
__fastcall TFormCategoryColours::TFormCategoryColours(TComponent* Owner)
	: TForm(Owner)
{
}
...
void OpenCategoryColours()
{
    ...
    delete FormCategoryColours;
}



void __fastcall TFormCategoryColours::FormCreate(TObject *Sender)
{
...
void __fastcall TFormCategoryColours::FormShow(TObject *Sender)
{
