...
procedure TfrmExcludedFolders.bOpenClick(Sender: TObject);
 begin
  ...
  odExclude.Filter     := XText[kTextFiles] + ' (*.txt)|*.txt';
...
procedure TfrmExcludedFolders.bSaveClick(Sender: TObject);
 begin
  ...
  sdExclude.Filter     := XText[kTextFiles] + ' (*.txt)|*.txt';
...
procedure TfrmExcludedFolders.FormCreate(Sender: TObject);
 begin
  Caption                 := XText[kExcludeFromScan];
  cbIgnoreVirtual.Caption := XText[kIgnoreVirtualFolders];
  bCancel.Caption         := XText[kCancel];
  sbSpecial.Caption       := XText[kSpecial];
  bSave.Caption           := XText[kSave];
  bOpen.Caption           := XText[kOpen];
...
procedure TfrmExcludedFolders.sbEditClick(Sender: TObject);
 ...
 begin
  s := InputBox(XText[kEditExclusion], XText[kEdit], lbExcluded.Items[lbExcluded.ItemIndex]);
