...
void XExploder::SetMode(int)
{
}


void XExploder::BeginData(const std::wstring)
{
}


void XExploder::AddData(const std::wstring, int, int, unsigned __int64, int)
{
}
...
XExploderDataObject XExploder::GetItem(int)
{
}
