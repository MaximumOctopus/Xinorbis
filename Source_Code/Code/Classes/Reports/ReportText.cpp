...
{
	void Generate(TextReportOptions report, std::vector<std::wstring> *data, int DataSource)
	{
	...
	void CreateDeepReport(std::vector<std::wstring> *data, int DataSource)
	{
		ReportDeep deep;
	...
	void ReportHeader(std::vector<std::wstring> *data)
	{
		data->push_back(GLanguageHandler->TextReport[0] + L"\n");
		data->push_back(L"--------------------------------------------------------------------------------\n");
	...
	void ReportAttributes(std::vector<std::wstring> *data, int DataSource)
	{
	...
	void ReportCategories(std::vector<std::wstring> *data, int DataSource)
	{
	...
	void ReportDirectoryList(std::vector<std::wstring> *data, int DataSource)
	{
		TitleBlock5Row(data, 5, 6);
...
// to do				std::ranges::sort(GScanEngine->Data[DataSource].RootFolders, {}, &RootFolder::Name);
	...
	void ReportExtensions(std::vector<std::wstring> *data, TextReportOptions report, int DataSource)
	{
	...
	void ReportLargestFiles(std::vector<std::wstring> *data, int DataSource)
	{
	...
	void ReportSmallestFiles(std::vector<std::wstring> *data, int DataSource)
	{
	...
	void ReportNewestFiles(std::vector<std::wstring> *data, int DataSource)
	{
	...
	void ReportOldestFiles(std::vector<std::wstring> *data, int DataSource)
	{
	...
	void TitleBlock5Row(std::vector<std::wstring> *data, int language_id_1, int language_id_2)
	{
		data->push_back(GLanguageHandler->TextReport[0] + L"\n");
	...
	void TitleBlock3Row(std::vector<std::wstring> *data, int language_id)
	{
		data->push_back(GLanguageHandler->TextReport[0] + L"\n");
