...
USEFORM("Code\Frames\XFrameFolderHistory.cpp", Frame1); /* TFrame: File Type */
...
int WINAPI _tWinMain(HINSTANCE, HINSTANCE, LPTSTR, int)
{
	try
	{
		...
		Application->CreateForm(__classid(TFormReportSaves), &FormReportSaves);
		...
		Application->CreateForm(__classid(TFormCheckVersion), &FormCheckVersion);
